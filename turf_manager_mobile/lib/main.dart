...
class _TurfDashboardScreenState extends State<TurfDashboardScreen> {
  ...
  Future<void> _fetchDashboardData() async {
    ...
    final urlString = _showSquadOnly 
        ? '${ApiConfig.baseUrl}/me/dashboard?filter=squad'
        : '${ApiConfig.baseUrl}/me/dashboard';

    final url = Uri.parse('${ApiConfig.baseUrl}/me/dashboard');
...
class _MatchDetailsScreenState extends State<MatchDetailsScreen> {
  ...
  Future<void> _fetchRoster() async {
    ...
    final url = Uri.parse('${ApiConfig.baseUrl}/matches/${widget.match['id']}/roster');
  ...
  Future<void> _joinMatch() async {
    ...
    final url = Uri.parse('${ApiConfig.baseUrl}/rsvps/');
  ...
  Future<void> _leaveMatch() async {
    ...
    final url = Uri.parse('${ApiConfig.baseUrl}/matches/${widget.match['id']}/leave');
...
class _CreateSquadScreenState extends State<CreateSquadScreen> {
  ...
  Future<void> _createSquad() async {
    ...
    final url = Uri.parse('${ApiConfig.baseUrl}/squads/');
...
class _JoinSquadScreenState extends State<JoinSquadScreen> {
  ...
  Future<void> _joinSquad() async {
    ...
    final url = Uri.parse('${ApiConfig.baseUrl}/squads/join');
...
class _MatchLedgerScreenState extends State<MatchLedgerScreen> {
  ...
  Future<void> _fetchFinancials() async {
    ...
    final url = Uri.parse('${ApiConfig.baseUrl}/matches/${widget.matchId}/financials');
  ...
  Future<void> _settlePayment(int userId) async {
    ...
    final url = Uri.parse('${ApiConfig.baseUrl}/matches/${widget.matchId}/settle/$userId');
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _updateProfile() async {
    ...
    final url = Uri.parse('${ApiConfig.baseUrl}/me/profile');
